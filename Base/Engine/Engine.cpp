...
ConstBufferManager* Engine::constBufferManager_ = nullptr;
...
void Engine::Initialize(uint32_t width, uint32_t height) {
	...
	constBufferManager_ = ConstBufferManager::GetInstance();
...
// 三角形
void Engine::DrawTriangle(const std::string& name, const std::string textureName, PipelineType pipelineType, BlendMode blendMode) {
	...
	// ConstBufferのセット
	constBufferManager_->SetConstBuffer(commandList.Get(), pipelineType, DTriangle, name);
...
// スプライト
void Engine::DrawSprite(const std::string& name, const std::string textureName, PipelineType pipelineType, BlendMode blendMode) {
	name;
	textureName;
	pipelineType;
	blendMode;
...
// 球
void Engine::DrawSphere(const std::string& name, const std::string textureName, PipelineType pipelineType, BlendMode blendMode) {
	...
	pipelineManager_->SetGraphicsPipeline(commandList.Get(), pipelineType, blendMode);
	// ConstBufferのセット
	constBufferManager_->SetConstBuffer(commandList.Get(), pipelineType, DSphere, name);
	// SRVのセット
	textureManger_->SetGraphicsRootDescriptorTable(commandList.Get(), 2, textureName);
...
// モデル
void Engine::DrawModel(const std::string& name, const std::string modelName, const std::string textureName, PipelineType pipelineType, BlendMode blendMode) {
	...
	// ConstBufferのセット
	constBufferManager_->SetConstBuffer(commandList.Get(), pipelineType, DModel, name);
	// SRVのセット
	textureManger_->SetGraphicsRootDescriptorTable(commandList.Get(), 2, textureName);
...
void Engine::DrawParticle(
	...
	modelManager_->IASetVertexBuffers(commandList.Get(), modelName);
	// ConstBufferのセット
	constBufferManager_->SetConstBuffer(commandList.Get(), pipelineType, DParticle, name);
	// SRVのセット
	textureManger_->SetGraphicsRootDescriptorTable(commandList.Get(), 2, textureName);
	// instacning
...
// GS
void Engine::DrawGSModel(const std::string& name, const std::string textureName, PipelineType pipelineType, BlendMode blendMode) {
	...
	pipelineManager_->SetGraphicsPipeline(commandList.Get(), pipelineType, blendMode);
	// ConstBufferのセット
	constBufferManager_->SetConstBuffer(commandList.Get(), pipelineType, DGSModel, name);
	// SRVのセット
